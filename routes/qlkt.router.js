...
router.get('/printyeucau',authenticated, async (req, res) => {
  ...
  if (doc) {
    ...
    return res.render('docformtoejs/phieuyeucau.ejs', { data: doc, _username: '', tentruongphong: tentruongphong, mota: fixmota, motakythuat : fixmotakythuat, myPathENV: process.env.myPathENV })
  }
